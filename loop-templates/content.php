...
<article <?php post_class('pb-4 mb-4 border-bottom'); ?> id="post-<?php the_ID(); ?>">
		...
		<div class="row">
			...
			<div class="col-md-8">
                ...
                <header class="entry-header">
                    <?php
                    the_title(
                        sprintf('<h2 class="content-title"><a class="fs-4" href="%s" rel="bookmark">', esc_url(get_permalink())),
                        '</a></h2>'
                    );
                    ?>
                </header><!-- .entry-header -->
